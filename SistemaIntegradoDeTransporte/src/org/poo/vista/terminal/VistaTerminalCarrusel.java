...
public class VistaTerminalCarrusel extends BorderPane {
        ...
        btnEliminar.setOnAction(e -> {
            if (objCargado.getCantidadEmpresasTerminal() == 0) {
                String mensaje = "¿Seguro que desea eliminar esta terminal?\n\n"
                        ...
                        + "Ciudad: " + objCargado.getCiudadTerminal()+ "\n\n"
    ...
    private void mostrarDatos() {
        ...
        lblCiudad.setFont(Font.font("Rockwell", tamanioFuente));
        lblCiudad.setTextFill(Color.web(Configuracion.AZUL_OSCURO));
        ...
        lblDireccion.setFont(Font.font("Rockwell", tamanioFuente));
        lblDireccion.setTextFill(Color.web(Configuracion.AZUL_OSCURO));
        ...
        lblPlataformas.setFont(Font.font("Rockwell", tamanioFuente));
        lblPlataformas.setTextFill(Color.web(Configuracion.AZUL_OSCURO));
        ...
        lblServicios.setFont(Font.font("Rockwell", tamanioFuente));
        lblServicios.setTextFill(Color.web(Configuracion.AZUL_OSCURO));
        ...
        lblCantEmpresas.setFont(Font.font("Rockwell", tamanioFuente));
        lblCantEmpresas.setTextFill(Color.web(Configuracion.AZUL_OSCURO));
