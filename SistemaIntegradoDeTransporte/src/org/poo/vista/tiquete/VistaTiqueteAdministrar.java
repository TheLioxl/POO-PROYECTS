...
public class VistaTiqueteAdministrar extends StackPane {
    ...
    public VistaTiqueteAdministrar(Stage ventanaPadre, BorderPane princ, Pane pane,
    ...
    private TableColumn<TiqueteDto, String> crearColumnaImagen() {
        ...
        columna.setCellFactory(column -> new TableCell<TiqueteDto, String>() {
            @Override
        ...
        btnEliminar.setOnAction((e) -> {
            if (miTabla.getSelectionModel().getSelectedItem() == null) {
                Mensaje.mostrar(Alert.AlertType.WARNING,
                        miEscenario, "Advertencia", "Debe seleccionar un tiquete");
            } else {
                ...
                if (msg.showAndWait().get() == ButtonType.OK) {
                    ...
                    if (TiqueteControladorEliminar.borrar(posi)) {
                        int canti = TiqueteControladorListar.obtenerCantidadTiquetes();
                        titulo.setText("ADMINISTRAR TIQUETES (" + canti + ")");

                        datosTabla.setAll(TiqueteControladorListar.obtenerTiquetes());
                        miTabla.refresh();
        ...
        btnActualizar.setOnAction((e) -> {
            if (miTabla.getSelectionModel().getSelectedItem() == null) {
                Mensaje.mostrar(Alert.AlertType.WARNING,
                        ...
                        "Debe seleccionar un tiquete para editar");
            } else {
                TiqueteDto objTiquete = miTabla.getSelectionModel().getSelectedItem();
                int posi = miTabla.getSelectionModel().getSelectedIndex();
