...
public class VistaConductorAdministrar extends StackPane{
    ...
    public VistaConductorAdministrar(Stage ventanaPadre, BorderPane princ, Pane pane,
    ...
    private TableColumn<ConductorDto, String> crearColumnaImagen() {
        ...
        columna.setCellFactory(column -> new TableCell<ConductorDto, String>() {
            @Override
    ...
    private void crearTabla() {
        ...
        datosTabla.setAll(arrConductores);
        ...
        btnEliminar.setOnAction((e) -> {
            if (miTabla.getSelectionModel().getSelectedItem() == null) {
                Mensaje.mostrar(Alert.AlertType.WARNING,
                        miEscenario, "Advertencia", "Debe seleccionar un conductor");
            } else {
                ConductorDto objConductor = miTabla.getSelectionModel().getSelectedItem();

                String mensaje = "¿Está seguro de eliminar este conductor?\n\n"
                        + "Código: " + objConductor.getIdConductor() + "\n"
                        + "Conductor: " + objConductor.getNombreConductor() + "\n"
                        + "Cédula: " + objConductor.getCedulaConductor() + "\n\n"
                ...
                if (msg.showAndWait().get() == ButtonType.OK) {
                    ...
                    if (ConductorControladorEliminar.borrar(posi)) {
                        int canti = ConductorControladorListar.obtenerCantidadConductores();
                        titulo.setText("ADMINISTRAR CONDUCTORES (" + canti + ")");
        ...
        btnActualizar.setOnAction((e) -> {
            if (miTabla.getSelectionModel().getSelectedItem() == null) {
                Mensaje.mostrar(Alert.AlertType.WARNING,
                        ...
                        "Debe seleccionar un conductor para editar");
            } else {
                ConductorDto objConductor = miTabla.getSelectionModel().getSelectedItem();
                int posi = miTabla.getSelectionModel().getSelectedIndex();
